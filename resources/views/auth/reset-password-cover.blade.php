...
<head>
    ...
    <title>Reset Password | Yerodabi</title>
...
<body>
                                        ...
                                        <div class="card border-1 p-lg-3 shadow-md rounded-3">
                                            <div class="card-body">
                                                <div class="text-center mb-3">
                                                    <h5 class="mb-1 fs-20 fw-bold">Réinitialiser le mot de passe</h5>
                                                    <p class="mb-0">Votre nouveau mot de passe doit être différent des mots de passe utilisés précédemment.</p>
                                                </div>
                                                <div class="mb-3">
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="009de6ca9f71a77fbd8d9a7f-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="009de6ca9f71a77fbd8d9a7f-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="009de6ca9f71a77fbd8d9a7f-text/javascript"></script>

    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="009de6ca9f71a77fbd8d9a7f-|49" defer></script>
</body>
