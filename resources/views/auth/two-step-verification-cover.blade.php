...
<body>
                                        ...
                                        <div class="card border-1 p-lg-3 shadow-md rounded-3">
                                            <div class="card-body">
                                                <div class="text-center mb-3">
                                                    <h5 class="mb-1 fs-20 fw-bold">Vérification en 2 étapes</h5>
                                                    <p class="mb-0">Veuillez saisir le mot de passe à usage unique
                                                        reçu pour confirmer la propriété de votre compte. Un code a été
                                                        envoyé <span class="text-dark b-block">
                                                            ******pi@gmail.com</span> </p>
                                                </div>
                                                <div class="text-center otp-input">
                                                    <div class="d-flex align-items-center justify-content-center mb-3">
                                                        ...
                                                        <input type="text"
                                                            class="border rounded text-center fs-26 fw-bold"
                                                            id="digit-4" name="digit-4" data-next="digit-5"
                                                            data-previous="digit-3" maxlength="1">
                                                    </div>
                                                    <div class="d-flex justify-content-center">
                                                        <div class="mb-3 d-flex align-items-center ">
                                                            <p class="text-gray-9 me-4 mb-0">Code non reçu. <a
                                                ...
                                                <div class="mt-0">
                                                    <button type="submit"
                                                        class="btn bg-primary text-white w-100">Soumettre </button>
                                                </div>
                                            </div><!-- end card body -->
                                        </div><!-- end card -->
                                    </div>
    ...
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="b85604528a516075cf5f8eff-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="b85604528a516075cf5f8eff-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="b85604528a516075cf5f8eff-text/javascript"></script>

    <script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="b85604528a516075cf5f8eff-|49" defer></script>
</body>
