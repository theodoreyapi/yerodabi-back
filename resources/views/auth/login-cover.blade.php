...
<body>
                                        ...
                                        <div class="card border-1 p-lg-3 shadow-md rounded-3 m-0">
                                            <div class="card-body">
                                                <div class="text-center mb-3">
                                                    <h5 class="mb-1 fs-20 fw-bold">Se connecter</h5>
                                                    <p class="mb-0">Veuillez saisir les informations ci-dessous pour
                                                ...
                                                <div class="d-flex align-items-center justify-content-between mb-3">
                                                    ...
                                                    <div class="text-end">
                                                        <a href="{{ url('forgot') }}" class="text-danger">Mot de
                                                            passe oublié?</a>
                                                    </div>
                                                </div>
                                                <div class="mb-2">
                                                    <button type="submit" class="btn bg-primary text-white w-100">Se
                                                        connecter</button>
                                                </div>
                                                ...
                                                <div class="text-center">
                                                    <h6 class="fw-normal fs-14 text-dark mb-0">Vous n'avez pas encore de
                                                        compte ?
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="8323fae756086b6cf5e266ee-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="8323fae756086b6cf5e266ee-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="8323fae756086b6cf5e266ee-text/javascript"></script>
</body>
