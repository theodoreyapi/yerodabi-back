...
<head>
    ...
    <title>Terms and Conditions - Medical & Hospital - Bootstrap 5 Admin Template</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="d18ab978602147a95f37d596-text/javascript"></script>
...
<body>
        ...
        <header class="navbar-header">
            <div class="page-container topbar-menu">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a id="mobile_btn" class="mobile-btn" href="terms-and-conditions.html#sidebar">
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li class="submenu submenu-two">
                                            <a href="terms-and-conditions.html#">Calls<span class="menu-arrow inside-submenu"></span></a>
                                            <ul>
                                        ...
                                        <li class="submenu submenu-two">
                                            <a href="terms-and-conditions.html#">Invoices<span class="menu-arrow inside-submenu"></span></a>
                                            <ul>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="unorder-list">
                                <li class="list-item"><p class="fw-medium">Provide Accurate Information.</p></li>
                                <li class="list-item"><p class="fw-medium">Maintain Account Security.</p></li>
                                <li class="list-item"><p class="fw-medium">Use the Platform Appropriately.</p></li>
                                <li class="list-item"><p class="fw-medium">Respect Privacy and Confidentiality.</p></li>
                                <li class="list-item"><p class="fw-medium">Compliance with Laws and Policies.</p></li>
                            </ul>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="unorder-list">
                                <li class="list-item"><p class="fw-medium">Dot not Share access any data, systems, or features that you are not explicitly authorized to use.</p></li>
                                <li class="list-item"><p class="fw-medium">Do not share login credentials or allow unauthorized users to access the platform under your account.</p></li>
                                <li class="list-item"><p class="fw-medium">Do not enter, upload, or store false, misleading, or fabricated patient or medical data.</p></li>
                                <li class="list-item"><p class="fw-medium">Do not modify or delete records without proper authorization or clinical justification.</p></li>
                            </ul>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="unorder-list">
                                ...
                                <li class="list-item"><p class="fw-medium">You compromise the security, integrity, or confidentiality of patient or system data.</p></li>
                                <li class="list-item"><p class="fw-medium">Required by law or regulatory authorities.</p></li>
                                <li class="list-item"><p class="fw-medium">Your actions interfere with normal platform operations or the delivery of care.</p></li>
                            </ul>
                        </div>
                        ...
                        <div class="mb-0">
                            ...
                            <p class="mb-0">We reserve the right to modify or update these Terms and Conditions at any time. Any changes will be posted on this page with a revised effective date. It is your responsibility to review these terms periodically to stay informed of any updates.</p>
                        </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="d18ab978602147a95f37d596-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="d18ab978602147a95f37d596-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="d18ab978602147a95f37d596-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="d18ab978602147a95f37d596-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="d18ab978602147a95f37d596-|49" defer></script></body>
