...
<head>
    ...
    <title>Privacy Policy - Medical & Hospital - Bootstrap 5 Admin Template</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="333dcc99a0d7d61bf2b2accc-text/javascript"></script>
...
<body>
        ...
        <header class="navbar-header">
            <div class="page-container topbar-menu">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a id="mobile_btn" class="mobile-btn" href="privacy-policy.html#sidebar">
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li class="submenu submenu-two">
                                            <a href="privacy-policy.html#">Calls<span class="menu-arrow inside-submenu"></span></a>
                                            <ul>
                                        ...
                                        <li class="submenu submenu-two">
                                            <a href="privacy-policy.html#">Invoices<span class="menu-arrow inside-submenu"></span></a>
                                            <ul>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="unorder-list">
                                <li class="list-item"><p class="fw-medium"><span class="text-dark">Personal Identifiable Information :</span> Full name, Date of birth, Contact details (email address, phone number), Date of birth,  Gender.</p></li>
                                <li class="list-item"><p class="fw-medium"><span class="text-dark">Health and Wellness Information :</span> Medical conditions (past and current), Allergies and medications, Diagnostic results (lab tests, imaging reports), Treatment records and progress notes. </p></li>
                                <li class="list-item"><p class="fw-medium"><span class="text-dark">Optional Information :</span> Emergency contact details, Consent forms or communication preferences. </p></li>
                            </ul>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="unorder-list">
                                ...
                                <li class="list-item"><p>Communicate with you and your healthcare providers.</p></li>
                                <li class="list-item"><p> Track and review medical history for accurate diagnosis.</p></li>
                                <li class="list-item"><p>Identify potential allergies, interactions, or risks</p></li>
                            </ul>
                        </div>

                        <div class="mb-3">
                            <h6 class="fw-bold mb-3">Sharing Your Information</h6>
                            <p>We will not sell or share your personal information with third parties except:</p>
                            <ul class="unorder-list">
                                <li class="list-item"><p>Doctors, nurses, specialists, and other licensed professionals directly involved in your care.</p></li>
                                <li class="list-item"><p>For consultation, diagnosis, treatment planning, and care coordination.</p></li>
                            </ul>
                        </div>

                        <div class="mb-3">
                            <h6 class="fw-bold mb-3">Data Security</h6>
                            <p>We implement appropriate technical and organizational measures to protect your personal data from unauthorized access, alteration, or disclosure. However, no method of transmission over the internet is 100% secure, and we cannot guarantee absolute security.</p>
                        </div>

                        <div class="mb-3">
                            <h6 class="fw-bold mb-3">Data Retention</h6>
                            <p>We will retain your personal information for as long as necessary to fulfill the purposes outlined in this policy, or as required by law.</p>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="unorder-list">
                                ...
                                <li class="list-item"><p>Ask for your information not to be shared with certain people</p></li>
                                <li class="list-item"><p>The health care provider or insurance company.</p></li>
                                <li class="list-item"><p>Communication to be reached at a specific place</p></li>
                            </ul>
                        </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="333dcc99a0d7d61bf2b2accc-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="333dcc99a0d7d61bf2b2accc-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="333dcc99a0d7d61bf2b2accc-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="333dcc99a0d7d61bf2b2accc-text/javascript"></script>

<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="333dcc99a0d7d61bf2b2accc-|49" defer></script></body>
