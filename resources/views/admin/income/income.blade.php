...
<body>
            ...
            <div class="content">
                ...
                <div
                    ...
                    <div class="flex-grow-1">
                        <h4 class="fw-bold mb-0"> Income <span
                    ...
                    <div class="text-end d-flex">
                        ...
                        <div class="dropdown me-1">
                            ...
                            <ul class="dropdown-menu p-2">
                                <li>
                                    <a class="dropdown-item" href="income.html#">Download as PDF</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="income.html#">Download as Excel</a>
                                </li>
                            </ul>
                        </div>
                        <a href="javascript:void(0);" class="btn btn-primary ms-2 fs-13 btn-md" data-bs-toggle="modal"
                            data-bs-target="#add_new_income"><i class="ti ti-plus me-1"></i>New Income </a>
                    </div>
                </div>
                <!-- End Page Header -->
                ...
                <div class="table-responsive">
                    <table class="table table-nowrap datatable">
                        ...
                        <tbody>
                            <tr>
                                <td> <a href="income.html">General Consultation</a></td>
                                ...
                                <td> <span
                                        class="badge badge-soft-success rounded text-success fw-medium border border-success">Received</span>
                                </td>
                                    ...
                                    <ul class="dropdown-menu p-2">
                                        <li>
                                            <a href="javascript:void(0);"
                                                ...
                                                data-bs-target="#edit_new_income">Edit</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);"
                                                class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td> <a href="income.html">Blood Test</a></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label mb-1 text-dark fs-14 fw-medium">Income Name<span
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label mb-1 text-dark fs-14 fw-medium">Received From<span
                                        class="text-danger">*</span></label>
                                <div class="dropdown">
                                    <a href="javascript:void(0);"
            ...
            <div class="modal-content">
                <div class="modal-body text-center position-relative">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="income.html" class="btn btn-danger position-relative z-1"
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="26496615e670a1f646285e01-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="26496615e670a1f646285e01-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="26496615e670a1f646285e01-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="26496615e670a1f646285e01-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="26496615e670a1f646285e01-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="26496615e670a1f646285e01-text/javascript"></script>

    <!-- Datetimepicker JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="26496615e670a1f646285e01-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/bootstrap-datetimepicker.min.js" type="26496615e670a1f646285e01-text/javascript"></script>

    <!-- Rangeslider JS -->
    <script src="{{ URL::asset('') }}assets/plugins/ion-rangeslider/js/ion.rangeSlider.js" type="26496615e670a1f646285e01-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/ion-rangeslider/js/custom-rangeslider.js" type="26496615e670a1f646285e01-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/ion-rangeslider/js/ion.rangeSlider.min.js" type="26496615e670a1f646285e01-text/javascript"></script>

    <!-- Datatable JS -->
    <script src="{{ URL::asset('') }}assets/js/jquery.dataTables.min.js" type="26496615e670a1f646285e01-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/dataTables.bootstrap5.min.js" type="26496615e670a1f646285e01-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="26496615e670a1f646285e01-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="26496615e670a1f646285e01-|49" defer>
    </script>
</body>
