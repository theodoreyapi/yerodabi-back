...
<head>
    ...
    <title>Transactions | Yerodabi</title>
...
<body>
            ...
            <div class="content">
                    ...
                    <div class="text-end d-flex">
                        ...
                        <div class="dropdown me-1">
                            ...
                            <ul class="dropdown-menu p-2">
                                <li>
                                    <a class="dropdown-item" href="transactions.html#">Download as PDF</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="transactions.html#">Download as Excel</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-nowrap datatable">
                        ...
                        <tbody>
                            <tr>
                                <td> <a href="transactions.html">#TNX0025</a></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                ...
                                <td> <span
                                        class="badge badge-soft-success rounded text-success fw-medium border border-success">Completed</span>
                                </td>
                            </tr>

                            <tr>
                                <td> <a href="transactions.html">#TNX0024</a></td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-md me-2">
                                ...
                                <td> <span
                                        class="badge badge-soft-info rounded text-info fw-medium border border-info">Pending</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="modal-content">
                <div class="modal-body text-center position-relative">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="transactions.html" class="btn btn-danger position-relative z-1"
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>

    <!-- Datetimepicker JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/bootstrap-datetimepicker.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>

    <!-- Rangeslider JS -->
    <script src="{{ URL::asset('') }}assets/plugins/ion-rangeslider/js/ion.rangeSlider.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/ion-rangeslider/js/custom-rangeslider.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/ion-rangeslider/js/ion.rangeSlider.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>

    <!-- Datatable JS -->
    <script src="{{ URL::asset('') }}assets/js/jquery.dataTables.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/dataTables.bootstrap5.min.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="6d900cf6e0187ae82bc0e9a7-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="6d900cf6e0187ae82bc0e9a7-|49" defer>
    </script>
</body>
