...
<head>
    ...
    <title>Add Invoices | Yerodabi</title>
...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="https://preclinic.dreamstechnologies.com/html/template/add-in">
                    ...
                    <div class="card-footer">
                        <div class="d-flex gap-2 align-items-center justify-content-end mb-0">
                            <a href="add-invoices.html" class="btn btn-md bg-light text-dark fs-13 fw-medium rounded">
                                Cancel </a>
                            <a href="add-invoices.html" class="btn btn-md btn-primary fs-13 fw-medium rounded"
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>

    <!-- Datetimepicker JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/bootstrap-datetimepicker.min.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>

    <!-- Datatable JS -->
    <script src="{{ URL::asset('') }}assets/js/jquery.dataTables.min.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/dataTables.bootstrap5.min.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="dee84654d5aa0e0b44437f11-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="dee84654d5aa0e0b44437f11-|49" defer>
    </script>
</body>
