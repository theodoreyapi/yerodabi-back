...
<body>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="d-sm-flex align-items-center position-relative z-0 overflow-hidden p-3">
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    <img src="{{ $patients->photo == '' ? URL::asset('assets/img/users/user-08.jpg') : $patients->photo }}"
                                        alt="product" class="rounded">
                                </a>
                                <div>
                                    <p class="text-primary mb-1">#PT00{{ $patients->id_patient }}</p>
                                    <h5 class="mb-1"><a href="javascript:void(0);"
                                            class="fw-bold">{{ $patients->name }} {{ $patients->last_name }}</a>
                                    </h5>
                                    <p class="mb-3">{{ $patients->emplacement }}</p>
                                    <div class="d-flex align-items-center flex-wrap">
                                        <p class="mb-0 d-inline-flex align-items-center"><i
                                                class="ti ti-phone me-1 text-dark"></i>Téléphone : <span
                                                class="text-dark ms-1">{{ $patients->phone_code }}
                                                {{ $patients->phone }}</span></p>
                                        <span class="mx-2 text-light">|</span>
                                        <p class="mb-0 d-inline-flex align-items-center"><i
                                                class="ti ti-calendar-time me-1 text-dark"></i>Date de création : <span
                                                class="text-dark ms-1">{{ $patients->created_at }}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 d-flex">
                        <div class="card shadow-sm flex-fill w-100">
                            <div class="card-header">
                                <h5 class="fw-bold mb-0"><i class="ti ti-user-star me-1"></i>Apropos</h5>
                            </div>
                            <div class="card-body pb-0">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0">{{ $patients->birth_date }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="fs-13 fw-bold mb-1">Group sanguin</h6>
                                                <p class="mb-0">{{ $patients->sanguin }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="fs-13 fw-bold mb-1">Genre</h6>
                                                <p class="mb-0">{{ $patients->genre }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center mb-3">
                                            <span
                                                class="avatar rounded-circle bg-light text-dark flex-shrink-0 me-2 border"><i
                                                    class="ti ti-droplet fs-16 text-body"></i></span>
                                            <div>
                                                <h6 class="fs-13 fw-bold mb-1 text-truncate">Pays</h6>
                                                <p class="mb-0 d-inline-flex align-items-center text-truncate"><i
                                                        class="ti ti-point-filled me-1 text-success fs-18"></i>{{ $patients->pays_name }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="fs-13 fw-bold mb-1 text-truncate">Ville</h6>
                                                <p class="mb-0 d-inline-flex align-items-center text-truncate"><i
                                                        class="ti ti-point-filled me-1 text-danger fs-18"></i>{{ $patients->ville_name }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="fs-13 fw-bold mb-1">Nationnalité</h6>
                                                <p class="mb-0 d-inline-flex align-items-center text-truncate"><i
                                                        class="ti ti-point-filled me-1 text-success fs-18"></i>{{ $patients->nationalite }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="fs-13 fw-bold mb-1 text-truncate">Taille</h6>
                                                <p class="mb-0 d-inline-flex align-items-center text-truncate"><i
                                                        class="ti ti-point-filled me-1 text-success fs-18"></i>{{ $patients->taille }}
                                                    cm
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="fs-13 fw-bold mb-1 text-truncate">Code postal</h6>
                                                <p class="mb-0 d-inline-flex align-items-center text-truncate"><i
                                                        class="ti ti-point-filled me-1 text-danger fs-18"></i>{{ $patients->postal_code }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                <h6 class="fs-13 fw-bold mb-1 text-truncate">Poids</h6>
                                                <p class="mb-0 d-inline-flex align-items-center text-truncate"><i
                                                        class="ti ti-point-filled me-1 text-success fs-18"></i>{{ $patients->poids }}
                                                    kg
                                                </p>
                                            </div>
                                        </div>
    ...
    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="6a300700487a1d1ab0f0ac99-|49" defer>
    </script>
</body>
