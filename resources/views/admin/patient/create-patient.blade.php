...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <a href="javascript:void(0);" class="btn btn-primary">Ajouter Nouveau Patient</a>
                        </div>
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="5ee2f99ee09c37274860a372-text/javascript"></script>
    ...
    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="5ee2f99ee09c37274860a372-text/javascript"></script>
    ...
    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js"
        data-cf-settings="5ee2f99ee09c37274860a372-|49" defer></script>
</body>
