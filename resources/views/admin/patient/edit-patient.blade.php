            ...
            <div class="content">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <form action="{{ route('patients.update', $patients->id_patient) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="nom" value="{{ $patients->name }}" required
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label mb-1 fw-medium">Prénom<span
                                                            class="text-danger ms-1">*</span></label>
                                                    <input name="prenom" value="{{ $patients->last_name }}" required
                                                        type="text" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label mb-1 fw-medium">Téléphone<span
                                                            class="text-danger ms-1">*</span></label>
                                                    <input required type="tel" value="{{ $patients->phone }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label mb-1 fw-medium">E-mail<span
                                                            class="text-danger ms-1">*</span></label>
                                                    <input required type="email" value="{{ $patients->email }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label mb-1 fw-medium">Adresse<span
                                                            class="text-danger ms-1">*</span></label>
                                                    <input required type="text" value="{{ $patients->emplacement }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" value="{{ $patients->taille }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" value="{{ $patients->poids }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-icon-end position-relative">
                                                        <input required name="date"
                                                            value="{{ $patients->birth_date }}" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="genre" required class="select">
                                                        <option @if ($patients->genre == 'Homme') selected @endif
                                                            value="Homme">Homme</option>
                                                        <option @if ($patients->genre == 'Femme') selected @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="sanguin" required class="select">
                                                        <option @if ($patients->sanguin == 'O+') selected @endif
                                                            value="O+">O+</option>
                                                        <option @if ($patients->sanguin == 'O-') selected @endif
                                                            value="O-">O-</option>
                                                        <option @if ($patients->sanguin == 'A+') selected @endif
                                                            value="A+">A+</option>
                                                        <option @if ($patients->sanguin == 'A-') selected @endif
                                                            value="A-">A-</option>
                                                        <option @if ($patients->sanguin == 'B+') selected @endif
                                                            value="B+">B+</option>
                                                        <option @if ($patients->sanguin == 'B-') selected @endif
                                                            value="B-">B-</option>
                                                        <option @if ($patients->sanguin == 'AB+') selected @endif
                                                            value="AB+">AB+</option>
                                                        <option @if ($patients->sanguin == 'AB-') selected @endif
                                                            value="AB-">AB-</option>
                                                    </select>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select" name="statut" required>
                                                        <option @if ($patients->status == 'approved') selected @endif
                                                            value="approved">Approuvé</option>
                                                        <option @if ($patients->status == 'pending') selected @endif
                                                            value="pending">En attente</option>
                                                        <option @if ($patients->status == 'rejected') selected @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label mb-1 fw-medium">Mot de passe</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label mb-1 fw-medium">Nationnalité<span
                                                            class="text-danger ms-1">*</span></label>
                                                    <input required name="nationnalite"
                                                        value="{{ $patients->nationalite }}" type="text"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select required name="pays" id="pays" class="select">
                                                        ...
                                                        @foreach ($pays as $pay)
                                                            <option @if ($patients->pays_id == $pay->id_pays) selected @endif
                                                                value="{{ $pay->id_pays }}">{{ $pay->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select required name="ville" id="ville" class="select">
                                                        <option value="{{ $patients->ville_id }}">Sélectionne</option>
                                                    </select>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    <label class="form-label mb-1">Code postal<span
                                                            class="text-danger ms-1">*</span></label>
                                                    <input required name="code_postal"
                                                        value="{{ $patients->postal_code }}" type="text"
                                                        class="form-control">
                                                </div>
                                            </div>
