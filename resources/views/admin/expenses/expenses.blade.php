...
<head>
    ...
    <title>Expenses | Preclinic - Yerodabo</title>
...
<body>
            ...
            <div class="content">
                    ...
                    <div class="text-end d-flex">
                        ...
                        <div class="dropdown me-1">
                            ...
                            <ul class="dropdown-menu p-2">
                                <li>
                                    <a class="dropdown-item" href="expenses.html#">Download as PDF</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="expenses.html#">Download as Excel</a>
                                </li>
                            </ul>
                        </div>
                        <a href="javascript:void(0);" class="btn btn-primary ms-2 fs-13 btn-md" data-bs-toggle="modal"
                            data-bs-target="#add_new_expense"><i class="ti ti-plus me-1"></i>New Expense </a>
                    </div>
                </div>
                <!-- End Page Header -->
                ...
                <div class="table-responsive">
                    <table class="table table-nowrap datatable">
                        ...
                        <tbody>
                            <tr>
                                <td> <a href="expenses.html">Gloves & Masks</a></td>
                                    ...
                                    <ul class="dropdown-menu p-2">
                                        <li>
                                            <a href="javascript:void(0);"
                                                ...
                                                data-bs-target="#edit_new_expense">Edit</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);"
                                                class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                            ...
                            <tr>
                                <td> <a href="expenses.html">Microscope Parts</a></td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="text-dark fw-semibold">Esther Schmidt
                                        </a>
                                    </div>
                                </td>
                                <td class="text-dark">Debit Card</td>
                                <td> <span
                                        class="badge badge-soft-warning rounded text-warning fw-medium border border-warning">Pending</span>
                                </td>
                                <td class="action-item">
                                    <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                        <i class="ti ti-dots-vertical"></i>
                            ...
                            <tr>
                                <td> <a href="expenses.html">Thermometers</a></td>
                                <td class="text-dark"> Medical Supplies </td>
                            ...
                            <tr>
                                <td> <a href="expenses.html">Disinfectant Supplies</a></td>
                                ...
                                <td class="text-dark">Debit Card</td>
                                <td> <span
                                        class="badge badge-soft-danger rounded text-danger fw-medium border border-danger">Rejected
                                    </span> </td>
                                <td class="action-item">
                                    <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                        <i class="ti ti-dots-vertical"></i>
                            ...
                            <tr>
                                <td> <a href="expenses.html">IV Sets</a></td>
                                <td class="text-dark"> Medical Supplies </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="text-dark fw-semibold">Dottie Sellers
                                        </a>
                                    </div>
                                </td>
                                <td class="text-dark">PayPal</td>
                                <td> <span
                                        class="badge badge-soft-primary rounded text-primary fw-medium border border-primary">New</span>
                                </td>
                                <td class="action-item">
                                    <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                        <i class="ti ti-dots-vertical"></i>
                            ...
                            <tr>
                                <td> <a href="expenses.html">Reagent Refill</a></td>
                                <td class="text-dark"> Laboratory </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="text-dark fw-semibold">Cheryl Bilodeau
                                        </a>
                                    </div>
                                </td>
                                <td class="text-dark">Cheque</td>
                                <td> <span
                                        class="badge badge-soft-danger rounded text-danger fw-medium border border-danger">Rejected</span>
                                </td>
                                <td class="action-item">
                                    <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                        <i class="ti ti-dots-vertical"></i>
                            ...
                            <tr>
                                <td> <a href="expenses.html">Syringes & Gauze</a></td>
                                <td class="text-dark"> Medical Supplies </td>
                            ...
                            <tr>
                                <td> <a href="expenses.html">Blood Collection Tubes</a></td>
                                <td class="text-dark"> Laboratory </td>
                            ...
                            <tr>
                                <td> <a href="expenses.html">Bandages & Tapes</a></td>
                                <td class="text-dark"> Medical Supplies </td>
                            ...
                            <tr>
                                <td> <a href="expenses.html">Tissue Slides</a></td>
                                <td class="text-dark"> Laboratory </td>
                                <td class="fw-semibold text-dark"> $800</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label mb-1 text-dark fs-14 fw-medium">Expense Name<span
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label mb-1 text-dark fs-14 fw-medium">Category<span
                                        class="text-danger">*</span></label>
                                <div class="dropdown">
                                    <a href="javascript:void(0);"
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label mb-1 text-dark fs-14 fw-medium">Amount<span
                                        class="text-danger">*</span></label>
                                <div class="dropdown">
                                    <a href="javascript:void(0);"
                                        class="dropdown-toggle form-control w-100 d-flex align-items-center justify-content-between"
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label mb-1 text-dark fs-14 fw-medium">Purchased By<span
                                        class="text-danger">*</span></label>
                                <div class="dropdown">
                                    <a href="javascript:void(0);"
            ...
            <div class="modal-content">
                <div class="modal-body text-center position-relative">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="expenses.html" class="btn btn-danger position-relative z-1"
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>

    <!-- Datetimepicker JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/bootstrap-datetimepicker.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>

    <!-- Rangeslider JS -->
    <script src="{{ URL::asset('') }}assets/plugins/ion-rangeslider/js/ion.rangeSlider.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/ion-rangeslider/js/custom-rangeslider.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/ion-rangeslider/js/ion.rangeSlider.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>

    <!-- Datatable JS -->
    <script src="{{ URL::asset('') }}assets/js/jquery.dataTables.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/dataTables.bootstrap5.min.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="1e5aa87308f0fc4fb339a9da-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="1e5aa87308f0fc4fb339a9da-|49" defer>
    </script>
</body>
