...
<head>
    ...
    <!-- Theme Config Js -->
    <script src="{{ URL::asset('') }}assets/js/theme-script.js" type="1fa5ba1270217b6ca82c4d2b-text/javascript"></script>
...
<body>
                ...
                <div class="d-flex align-items-center justify-content-between pb-3 mb-3 border-bottom">
                    ...
                    <div class="text-end">
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#add_countries"><i class="ti ti-plus me-1"></i>Add New City</a>
                    </div>
                </div>
                <!-- End Page Header -->
                ...
                <div class="modal-content">
                    <div class="modal-body text-center position-relative">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="cities.html" class="btn btn-danger position-relative z-1">Yes, Delete</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="1fa5ba1270217b6ca82c4d2b-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="1fa5ba1270217b6ca82c4d2b-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="1fa5ba1270217b6ca82c4d2b-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="1fa5ba1270217b6ca82c4d2b-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="1fa5ba1270217b6ca82c4d2b-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="1fa5ba1270217b6ca82c4d2b-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="1fa5ba1270217b6ca82c4d2b-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="1fa5ba1270217b6ca82c4d2b-|49" defer>
    </script>
</body>
