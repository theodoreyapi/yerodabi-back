...
<head>
    ...
    <title>Countries - Yerodabi</title>
    ...
    <!-- Theme Config Js -->
    <script src="{{ URL::asset('') }}assets/js/theme-script.js" type="f7548054131b0891bf888f10-text/javascript"></script>
...
<body>
                ...
                <div class="d-flex align-items-center justify-content-between pb-3 mb-3 border-bottom">
                    ...
                    <div class="text-end">
                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#add_countries"><i class="ti ti-plus me-1"></i>Add New Countries</a>
                    </div>
                </div>
                <!-- End Page Header -->
                                    ...
                                    <ul class="dropdown-menu p-2">
                                        <li>
                                            <a href="javascript:void(0);"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#edit_countries">Edit</a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0);"
                                                class="dropdown-item d-flex align-items-center"
                                                data-bs-toggle="modal" data-bs-target="#delete_countries">Delete</a>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="f7548054131b0891bf888f10-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="f7548054131b0891bf888f10-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="f7548054131b0891bf888f10-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="f7548054131b0891bf888f10-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="f7548054131b0891bf888f10-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="f7548054131b0891bf888f10-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="f7548054131b0891bf888f10-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js"
        data-cf-settings="f7548054131b0891bf888f10-|49" defer></script>
</body>
