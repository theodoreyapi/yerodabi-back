                    ...
                    <div class="card-body d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                        <div class="d-flex align-items-center flex-sm-nowrap flex-wrap row-gap-3">
                            <div class="me-3 doctor-profile-img"><a href="doctor-details.html"><img
                                        src="{{ $doctor->photo == '' ? URL::asset('assets/img/doctors/doctor-01.jpg') : $doctor->photo }}"
                                        class="rounded" alt=""></a></div>
                            <div class="flex-fill">
                                <div class="d-flex align-items-center mb-1">
                                    <h6 class="mb-0 fw-semibold">Dr. {{ $doctor->name }} {{ $doctor->last_name }}</h6>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    @if ($doctor->status == 'approved')
                                        <span class="badge badge-soft-success fw-medium ms-2"><i
                                                class="ti ti-point-filled me-1 text-success"></i>Approuvé</span>
                                    @elseif ($doctor->status == 'rejected')
                                        <span class="badge badge-soft-danger fw-medium ms-2"><i
                                                class="ti ti-point-filled me-1 text-danger"></i>Rejeté</span>
                                    @else
                                        <span class="badge badge-soft-warning fw-medium ms-2"><i
                                                class="ti ti-point-filled me-1 text-warning"></i>En
                                            attente</span>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            ...
                                            <p><a href="#"
                                                    class="__cf_email__"
                                                    data-cfemail="5e343136301e3b263f332e323b703d3133">{{ $doctor->email }}</a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
