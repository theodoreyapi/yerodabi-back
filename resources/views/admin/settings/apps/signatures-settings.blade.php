...
<head>
    ...
    <title>Signatures Settings - Yerodabi</title>
    ...
    <!-- Theme Config Js -->
    <script src="{{ URL::asset('') }}assets/js/theme-script.js" type="c53dbeedf9ec3decc434593a-text/javascript"></script>
...
<body>
                                        ...
                                        <ul>
                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="signatures-settings.html" class="active">Signatures</a>
                                                    </li>
                                        ...
                                        <table class="table table-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><img src="{{ URL::asset('') }}assets/img/icons/signature-01.svg"
                                                ...
                                                <tr>
                                                    <td>Michael Smith</td>
                                                    <td><img src="{{ URL::asset('') }}assets/img/icons/signature-02.svg"
                                                            alt="img" class="img-fluid"></td>
                                                    <td><span
                                                            class="badge bg-soft-success fs-13 fw-medium text-success border border-success py-1 px-2">Active</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>Alberto Alleo</td>
                                                    <td><img src="{{ URL::asset('') }}assets/img/icons/signature-03.svg"
                                                            alt="img" class="img-fluid"></td>
                                                    <td><span
                                                            class="badge bg-soft-success fs-13 fw-medium text-success border border-success py-1 px-2">Active</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{ URL::asset('') }}assets/img/icons/signature-04.svg"
                                                            alt="img" class="img-fluid"></td>
                                                    <td><span
                ...
                <div class="modal-content">
                    <div class="modal-body text-center position-relative">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="signatures-settings.html" class="btn btn-danger position-relative z-1">Yes,
                                Delete</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="c53dbeedf9ec3decc434593a-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="c53dbeedf9ec3decc434593a-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="c53dbeedf9ec3decc434593a-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="c53dbeedf9ec3decc434593a-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="c53dbeedf9ec3decc434593a-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="c53dbeedf9ec3decc434593a-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="c53dbeedf9ec3decc434593a-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="c53dbeedf9ec3decc434593a-|49" defer>
    </script>
</body>
