...
<head>
    ...
    <title>Bank Accounts - Yerodabi</title>
    ...
    <!-- Theme Config Js -->
    <script src="{{ URL::asset('') }}assets/js/theme-script.js" type="652971d3eacfcc1e5d79aa8c-text/javascript"></script>
...
<body>
                                        ...
                                        <ul>
                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="bank-accounts-settings.html" class="active">Bank
                                                            Accounts</a></li>
                                ...
                                <div class="card-header border-bottom px-0 mx-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#add_reason"><i class="ti ti-plus me-1"></i>New Bank
                                            Account</a>
                                    </div>
                                </div>
        ...
        <div id="add_reason" class="modal fade">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="bank-accounts-settings.html">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center position-relative">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="bank-accounts-settings.html" class="btn btn-danger position-relative z-1">Yes,
                                Delete</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="652971d3eacfcc1e5d79aa8c-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="652971d3eacfcc1e5d79aa8c-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="652971d3eacfcc1e5d79aa8c-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="652971d3eacfcc1e5d79aa8c-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="652971d3eacfcc1e5d79aa8c-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="652971d3eacfcc1e5d79aa8c-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="652971d3eacfcc1e5d79aa8c-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="652971d3eacfcc1e5d79aa8c-|49" defer>
    </script>
</body>
