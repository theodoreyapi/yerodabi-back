...
<head>
    ...
    <title>SMS Templates - Yerodabi</title>
    ...
    <!-- Theme Config Js -->
    <script src="{{ URL::asset('') }}assets/js/theme-script.js" type="c5283d0552f89f95804dc4bb-text/javascript"></script>
...
<body>
                                        ...
                                        <ul>
                                            ...
                                            <li class="submenu">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="sms-templates-settings.html" class="active">SMS
                                                            Templates</a></li>
                                ...
                                <div class="card-header border-bottom px-0 mx-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#add_template"><i class="ti ti-plus me-1"></i>New
                                            Template</a>
                                    </div>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action-item">
                                                        ...
                                                        <ul class="dropdown-menu p-2">
                                                            ...
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                    class="dropdown-item d-flex align-items-center">Clone</a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                    class="dropdown-item d-flex align-items-center"
        ...
        <div id="add_template" class="modal fade">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="sms-templates-settings.html">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="editor three-line">
                                    <p>Hi {Patient Name}, your appointment with Dr.{Doctor Name} on {Date} at {Time} is
                                        confirmed. – {Clinic Name}</p>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <input class="input-tags form-control" id="inputBox2" type="text"
                                    ...
                                    value="{Phone Number}, {Patient Name}, {Invoice ID}, {Date}, {Amount}, {Company Name}, {Clinic Name}, {Doctor Name}">
                            </div>
                            <div class="mb-0">
                                <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center position-relative">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="sms-templates-settings.html" class="btn btn-danger position-relative z-1">Yes,
                                Delete</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="c5283d0552f89f95804dc4bb-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="c5283d0552f89f95804dc4bb-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="c5283d0552f89f95804dc4bb-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="c5283d0552f89f95804dc4bb-text/javascript"></script>

    <!-- Quill JS -->
    <script src="{{ URL::asset('') }}assets/plugins/quill/quill.min.js" type="c5283d0552f89f95804dc4bb-text/javascript"></script>

    <!-- Bootstrap Tagsinput JS -->
    <script src="{{ URL::asset('') }}assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js" type="c5283d0552f89f95804dc4bb-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="c5283d0552f89f95804dc4bb-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="c5283d0552f89f95804dc4bb-|49" defer>
    </script>
</body>
