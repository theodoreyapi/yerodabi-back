...
<head>
    ...
    <!-- Theme Config Js -->
    <script src="{{ URL::asset('') }}assets/js/theme-script.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>
...
<body>
                    ...
                    <div class="col-lg-10 mx-auto">
                        ...
                        <div class="d-flex align-items-sm-center flex-sm-row flex-column mb-4">
                            <div class="flex-grow-1">
                                <h6 class="fw-bold mb-0 d-flex align-items-center "> <a
                                        href="{{ url('doctors-prescriptions') }}" class="me-1"><i
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div
                                    ...
                                    <div class="text-lg-end">
                                        <p class="text-dark mb-1"> Department : <span class="text-body"> Cardiology
                                                OP</span> </p>
                                        <p class="text-dark mb-1"> Prescribed on : : <span class="text-body"> Cardiology
                                                OP</span> </p>
                                        <p class="text-dark mb-0"> Consultation : : <span class="text-body"> Cardiology
                                                OP</span> </p>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center  gap-3">
                                            ...
                                            <p class="mb-0 text-dark"> Patient ID <span class="text-body"> PT0025</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Items -->
                                <div class="mb-4">
                                    <h6 class="mb-3 fs-16 fw-semibold text-center">Cardiology Prescription</h6>
                                    <div class="">
                                        <!-- Table List -->
                                            ...
                                            <table class="table table-nowrap">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="text-dark">Medecine Name</th>
                                                        <th class="text-dark">Dosage</th>
                                                        <th class="text-dark"> Frequency</th>
                                                        <th class="text-dark"> Duration </th>
                                                        <th class="text-dark"> Timings</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                ...
                                <div
                                    ...
                                    <div class="">
                                        <h6 class="mb-1 16-14 fw-semibold"> Follow Up </h6>
                                ...
                                <div class="text-center d-flex align-items-center justify-content-center">
                                    <a href="doctors-prescription-details.html"
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>

    <!-- Datatable JS -->
    <script src="{{ URL::asset('') }}assets/js/jquery.dataTables.min.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/js/dataTables.bootstrap5.min.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>

    <!-- Custom JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="3d184eed7763d1a3b1142e03-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="3d184eed7763d1a3b1142e03-|49" defer>
    </script>
</body>
