...
<head>
    ...
    <!-- Theme Config Js -->
    <script src="{{ URL::asset('') }}assets/js/theme-script.js" type="ebe3d9e9be04807762234f16-text/javascript"></script>
...
<body>
                            ...
                            <div class="col-lg-9">
                                <div class="border-1 border-start ps-4">
                                    ...
                                    <div class="d-flex justify-content-end align-items-center gap-2">
                                        <a href="doctors-profile-settings.html"
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="ebe3d9e9be04807762234f16-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="ebe3d9e9be04807762234f16-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="ebe3d9e9be04807762234f16-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="ebe3d9e9be04807762234f16-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="ebe3d9e9be04807762234f16-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="ebe3d9e9be04807762234f16-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="ebe3d9e9be04807762234f16-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="ebe3d9e9be04807762234f16-|49" defer>
    </script>
</body>
