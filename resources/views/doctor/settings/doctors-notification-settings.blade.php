...
<head>
    ...
    <!-- Theme Config Js -->
    <script src="{{ URL::asset('') }}assets/js/theme-script.js" type="9ac625677497669bff2cbe16-text/javascript"></script>
...
<body>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="text-start">
                                    <a href="{{ url('doctors-profile-settings') }}"
                                        class="btn btn-md rounded fs-14 fw-medium text-dark mb-1"> <i
                                            class="ti ti-user-cog me-2 text-dark"> </i>Profile Settings </a>
                                    <a href="{{ url('doctors-password-settings') }}"
                                        class="btn btn-md rounded fs-14 fw-medium text-dark mb-1"> <i
                                            class="ti ti-lock-star me-2 text-dark"> </i> Change Password </a>
                                    <a href="{{ url('doctors-notification-settings') }}"
    ...
    <!-- jQuery -->
    <script src="{{ URL::asset('') }}assets/js/jquery-3.7.1.min.js" type="9ac625677497669bff2cbe16-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ URL::asset('') }}assets/js/bootstrap.bundle.min.js" type="9ac625677497669bff2cbe16-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="{{ URL::asset('') }}assets/plugins/simplebar/simplebar.min.js" type="9ac625677497669bff2cbe16-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ URL::asset('') }}assets/plugins/select2/js/select2.min.js" type="9ac625677497669bff2cbe16-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ URL::asset('') }}assets/js/moment.min.js" type="9ac625677497669bff2cbe16-text/javascript"></script>
    <script src="{{ URL::asset('') }}assets/plugins/daterangepicker/daterangepicker.js" type="9ac625677497669bff2cbe16-text/javascript"></script>

    <!-- Main JS -->
    <script src="{{ URL::asset('') }}assets/js/script.js" type="9ac625677497669bff2cbe16-text/javascript"></script>

    <script src="{{ URL::asset('') }}assets/rocket-loader.min.js" data-cf-settings="9ac625677497669bff2cbe16-|49" defer>
    </script>
</body>
