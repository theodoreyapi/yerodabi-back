...
Route::resource('appointment-calendar', AppointmentCalendarController::class);
Route::get('add-doctor', function () {
    $specialisations = Specialisations::all();
    return view('admin.doctors.add-doctor', compact('specialisations'));
});
...
Route::get('create-patient', function () {
    $pays = Pays::all();
    return view('admin.patient.create-patient', compact('pays'));
});
Route::get('/villes-par-pays/{id_pays}', [PatientsController::class, 'getByPays'])
    ->name('villes.byPays');
